...
void getColor(int *leftID, int *rightID){
  ...
  if(leftBlueReading < blackBMaxLeft && leftBlueReading > blackBMinLeft && leftRedReading < blackRMaxLeft && leftRedReading > blackRMinLeft){
    *leftID = 1; // Reads Black
    Serial.print("left reads black with blue: ");
    Serial.print(leftBlueReading);
    Serial.print(" and red: ");
    Serial.print(leftRedReading);
  }else if(leftBlueReading < redBMaxLeft && leftBlueReading > redBMinLeft && leftRedReading < redRMaxLeft && leftRedReading > redRMinLeft){
    *leftID = 2; // Reads Red
    Serial.print("left reads red with reading: ");
    Serial.print(leftBlueReading);
    Serial.print(" and red: ");
    Serial.print(leftRedReading);
    ...
    *leftID = 3; // Reads Blue
    Serial.print("left reads blue with reading: ");
    Serial.print(leftBlueReading);
    Serial.print(" and red: ");
    Serial.print(leftRedReading);
    ...
    *leftID = 4; // Reads Yellow
    Serial.print("left reads yellow with reading: ");
    Serial.print(leftBlueReading);
    Serial.print(" and red: ");
    Serial.print(leftRedReading);
  }else{
    Serial.print("Left Found Invalid with reading: ");
    Serial.print(leftBlueReading);
    Serial.print(" and red: ");
    Serial.print(leftRedReading);
  }
  ...
  if(rightBlueReading < blackBMaxRight && rightBlueReading > blackBMinRight && rightRedReading < blackRMaxRight && rightRedReading > blackRMinRight){
    *rightID = 1; // Reads Black
    Serial.print(" | right reads black with reading: ");
    Serial.print(rightBlueReading);
    Serial.print(" and red: ");
    Serial.println(rightRedReading);
    ...
    *rightID = 2; // Reads Red
    Serial.print(" | right reads red with reading: ");
    Serial.print(rightBlueReading);
    Serial.print(" and red: ");
    Serial.println(rightRedReading);
    ...
    *rightID = 3; // Reads Blue
    Serial.print(" | right reads blue with reading: ");
    Serial.print(rightBlueReading);
    Serial.print(" and red: ");
    Serial.println(rightRedReading);
    ...
    *rightID = 4; // Reads Yellow
    Serial.print(" | right reads yellow with reading: ");
    Serial.print(rightBlueReading);
    Serial.print(" and red: ");
    Serial.println(rightRedReading);
  }else{
    Serial.print(" | right reads invalid with reading: ");
    Serial.print(rightBlueReading);
    Serial.print(" and red: ");
    Serial.println(rightRedReading);
  }
